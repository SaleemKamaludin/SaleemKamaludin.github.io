...
## Introduction
Mathematical expressions often contain several operations such as addition, subtraction, multiplication, division, and powers.  
...
<p style="text-align:center; margin:0.6rem 0;">
  $$(\color{#1565c0}{5})^{2}=25,\qquad
    (\color{#c62828}{2\sqrt{3}})^{2}=4\cdot3=12$$
</p>
