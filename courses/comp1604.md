...
<a class="btn" href="{{ '/courses/comp1604/lecture-notes/' | relative_url }}">📘 Lecture Notes</a>
 ...
 <!-- <a class="btn" href="{{ '/courses/comp1604/final-exam-practice/' | relative_url }}">🎯 Final Exam Practice</a> -->
</div>
...
## Assessment (Subject to change every year)
-  **Assignments** (10%)
