...
- [MATH 2276 – Discrete Mathematics]({{ '/courses/math-2276/' | relative_url }}) — Graph theory, recurrence relations, tournaments, matchings, and other topics in discrete mathematics.
...
- **MATH 1115 — Fundamental Mathematics for the General**
...
- <a href="{{ '/courses/graduate/advanced-discrete-mathematics/' | relative_url }}">MATH 6170 – Advanced Discrete Mathematics (F-Polynomials of Graphs)</a> — Generating functions, recurrence relations, graph polynomials, matching polynomials, circuit polynomials, and advanced enumerative combinatorics.
